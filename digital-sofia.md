...
- Електронно участие – дигиталният профил дава възможност за използване на електронни услуги, градски транспорт и участие в електронни референдуми и консултации.
...
За да направим София град на Дигиталният гражданин, ще се фокусираме върху следните приоритети:
...
- Изграждане на IoT (Internet of Things) мрежа – инфраструктурата за всички решения за умен град. Ще изградим такава инфраструктура в партньорство между общината и частния сектор, без да създаваме монополи.
...
- Пътна безопасност:
  ...
  - Ще въведем изискване към новопостроените сгради да се поставят различни видове сензори. Цената им е пренебрежимо малка и няма да натовари бизнеса, а получаването на информация чрез достатъчно сензори е ключово за развитието на умните градове.
...
- Предоставяне безплатно на обществени пространства (покриви на общински сгради, лампи за улично осветление, паркове) за IoT инфраструктура, чрез която да се улеснят проекти за „умен град“ при условие, че общината може да ползва мрежата безвъзмездно (при определени условия).
